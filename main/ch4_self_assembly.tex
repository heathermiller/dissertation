\chapter{Datatype Generic Programming for Distributed Programming}
...
specialized functionality~\cite{ScalaPickling}.
...
In our previous work on Scala/Pickling~\cite{ScalaPickling}, we sought to achieve
