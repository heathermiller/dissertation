...
type-based static meta-programming enables fast serialization~\cite{ScalaPickling},
...
studies~\cite{JavaSerialization, JavaRMI, Philippsen2000, Jaguar} report
on the high overhead of serialization in widely-used runtime environments such
as the JVM. Researchers have even found that serialization can account for 50\% of on a Spark cluster~\cite{OusterhoutSerialization}. This overhead is so important in practice that popular systems,
...
Avro~\cite{Avro}, or Kryo~\cite{Kryo} to meet their performance requirements.
...
% \vspace{-1mm}
\begin{figure}[!h]
\centering\includegraphics[width=0.6\columnwidth]{spore-shape.pdf}
\end{figure}
% \vspace{-1mm}
