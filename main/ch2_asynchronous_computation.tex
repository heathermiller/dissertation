...
completing another future. There are three sorts of callbacks that can be
handled by Scala's futures:
...
All three varieties methods which
...
implement a custom \verb|ExecutionContext| by simply importing the underlying
execution scheme, such as an implementation of an event loop or a Java
\verb|ExecutorService|, and implementing a few basic methods such as
\verb|execute| and \verb|reportFailure|.
