...
Figure~\ref{appdx:subtyping} shows the subtyping rules. Record (\textsc{S-Rec})
...
Section~\ref{sec:adv-usage-type-constraints}).
...
parameters~\cite{Lewis2000}; it is an environment for names whose definition
...
based on a pair of progress and preservation theorems~\cite{Wright1994}. In
...
described above (see Section~\ref{sec:adv-usage-type-constraints}).
