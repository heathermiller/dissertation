...
associated paper, \emph{FlowPools: A Lock-Free Deterministic Concurrent
Dataflow Abstraction}  \cite{Prokopec12}
...
\begin{lemmatwo}
Given a FlowPool consistent with some abstract pool,
CAS instructions in lines \ref{cas_propagate}
\end{lemmatwo}
